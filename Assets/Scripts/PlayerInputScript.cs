...
public class PlayerMovement : MonoBehaviour
{
    ...
    //Movement
    public float moveSpeed = 4500; // Character Movement Speed
    private float maxSpeed = 20; // For diagonal limiting
    ...
    //Crouch & Slide
    public Vector3 crouchScale = new Vector3(1, 0.5f, 1); // Scale while crouching
    private Vector3 playerScale; // Stores the original player scale
